...
function AssignmentTableStudent(props: any){
    ...
    useEffect(()=>{
        for (let i = 0; i < assignmentList.length; i++){
                ...
                let newjsx = <td> <input onKeyDown={enterKeyPressed} data-name={props.name} data-index={i} id={i+'assignment'+props.name+"end"+assignmentList[i].name} type={'number'} min={0} max={100}  placeholder={thisgrade}/></td>
