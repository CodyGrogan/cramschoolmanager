...
test('create student and schoolclass, expect classname to be myclass', () =>{
  ...
  let newstudent = new Student('billy', 11, 'john', 'mary', '123456', 'hello@fake.com', 'unknownid', 'unknownschoolname', 'unknownschoolid');
...
test('create student and schoolclass, expect student[0] to be billy', () =>{
  ...
  let newstudent = new Student('billy', 11, 'john', 'mary', '123456', 'hello@fake.com', 'unknownid', 'unknown', 'unknown');
  newclass.addStudent(newstudent);
...
test('if two students with same name added to class, dont add the student', () =>{
  ...
  let newclass = new SchoolClass('myclass', 'school', 'unknown');
  let newstudent = new Student('billy', 11, 'john', 'mary', '123456', 'hello@fake.com', 'unknownid', 'unknown', 'unknown');
  let newstudent2 = new Student('billy', 11, 'john', 'mary', '123456', 'hello@fake.com', 'unknownid', 'unknown', 'unknown');
  newclass.addStudent(newstudent);
